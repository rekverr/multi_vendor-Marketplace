...
export type ProcessedEventWhereInput = {
  ...
  consumerName?: Prisma.StringFilter<"ProcessedEvent"> | string
...
export type ProcessedEventWhereUniqueInput = Prisma.AtLeast<{
  consumerName_eventId?: Prisma.ProcessedEventConsumerNameEventIdCompoundUniqueInput
  AND?: Prisma.ProcessedEventWhereInput | Prisma.ProcessedEventWhereInput[]
  OR?: Prisma.ProcessedEventWhereInput[]
  NOT?: Prisma.ProcessedEventWhereInput | Prisma.ProcessedEventWhereInput[]
  consumerName?: Prisma.StringFilter<"ProcessedEvent"> | string
...
export type ProcessedEventScalarWhereWithAggregatesInput = {
  ...
  consumerName?: Prisma.StringWithAggregatesFilter<"ProcessedEvent"> | string
...
export type ProcessedEventConsumerNameEventIdCompoundUniqueInput = {
  consumerName: string
  eventId: string
}
...
export type ProcessedEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"consumerName" | "eventId" | "processedAt", ExtArgs["result"]["processedEvent"]>
...
export interface ProcessedEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const processedEventWithConsumerNameOnly = await prisma.processedEvent.findMany({ select: { consumerName: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProcessedEvents and only return the `consumerName`
   * const processedEventWithConsumerNameOnly = await prisma.processedEvent.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProcessedEvents and only return the `consumerName`
   * const processedEventWithConsumerNameOnly = await prisma.processedEvent.updateManyAndReturn({
   *   select: { consumerName: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProcessedEventFieldRefs {
  readonly consumerName: Prisma.FieldRef<"ProcessedEvent", 'String'>
