    ...
    void catalogApi
      ...
      .catch((requestError: unknown) => {
        if (!controller.signal.aborted)
          setFailure({ productId, message: errorMessage(requestError) });
      });
    return () => controller.abort();
  }, [productId, reload]);

  if (failure?.productId === productId)
    return (
      ...
      <section className="product-detail">
        ...
        <div className="detail-copy">
          ...
          <div className="detail-byline">
            <span>
              Sold by <strong>{product.seller.displayName}</strong>
            </span>
            <Rating
          ...
          {product.type === "AUCTION" && product.auction ? (
            <Link
