...
export function HomePage() {
  ...
  return (
    <main className="home-page">
      <section className="home-copy"><span className="eyebrow">Multi-vendor marketplace</span>
      ...
      <aside className="home-orbit" aria-label="Marketplace capabilities">
        <div className="orbit-core"><span>Live</span><strong>Market</strong></div>
        <span className="orbit-tag tag-one">Products</span><span className="orbit-tag tag-two">Auctions</span><span className="orbit-tag tag-three">Orders</span>
      </aside>
    </main>
  )
}
