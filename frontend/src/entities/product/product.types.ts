...
export interface ProductReference { id: string; title: string; description: string; imageUrl: string | null; stock: number }
export interface NamedReference { id: string; name: string }
export interface SellerReference { id: string; displayName: string }
...
export interface PublicBid { id: string; amount: string; createdAt: string }
export interface PublicAuction {
  ...
  createdAt: string
  updatedAt: string
  product: ProductReference & { seller: SellerReference; category: NamedReference }
